...
export default function Star({ color }) {
    ...
    color === 'highlight' ? (starColor = '#FF6060') : (starColor = '#E3E3E3')
    const star = (
        <svg
            className="star"
            width="25"
